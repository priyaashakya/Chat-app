...
const Sidebar = () => {
  ...
  return (
    <div
      className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-auto sidebar-scroll text-white ${
      ...
      <div className="flex flex-col">
        {filteredUsers?.map((user) => (
          <div
            ...
            className={`relative flex items-center gap-3 p-2 pl-4 rounded cursor-pointer hover:bg-[#282142]/40 ${
